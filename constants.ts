...
export const JOURNAL_LOCAL_STORAGE_KEY = 'art-i-fact-journal';
export const PROJECTS_LOCAL_STORAGE_KEY = 'art-i-fact-projects';
export const WELCOME_PORTAL_SEEN_KEY = 'art-i-fact-welcome-seen';