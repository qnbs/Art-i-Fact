...
export const Cog6ToothIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-1.007 1.11-1.11h2.593c.55-.103 1.02.367 1.11 1.11l.09 5.093a2.25 2.25 0 01-2.244 2.244H11.84a2.25 2.25 0 01-2.244-2.244L9.594 3.94zM14.378 18.026c.09.542.56 1.007 1.11 1.11h2.594c.55.103 1.02-.367 1.11-1.11l.09-5.093a2.25 2.25 0 00-2.244-2.244h-1.571a2.25 2.25 0 00-2.244 2.244l.09 5.093zM5.94 18.026c.09.542.56 1.007 1.11 1.11h2.594c.55.103 1.02-.367 1.11-1.11l.09-5.093a2.25 2.25 0 00-2.244-2.244H7.043a2.25 2.25 0 00-2.244 2.244l.09 5.093z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 18.75a.75.75 0 00-1.5 0v2.25a.75.75 0 001.5 0v-2.25zM12 2.25a.75.75 0 00-1.5 0v2.25a.75.75 0 001.5 0V2.25zM6.31 5.47a.75.75 0 00-1.06 1.06l1.59 1.59a.75.75 0 001.06-1.06L6.31 5.47zM16.63 17.69a.75.75 0 00-1.06 1.06l1.59 1.59a.75.75 0 001.06-1.06l-1.59-1.59zM21.75 12a.75.75 0 00-1.5 0v2.25a.75.75 0 001.5 0v-2.25zM3.75 12a.75.75 0 00-1.5 0v2.25a.75.75 0 001.5 0v-2.25zM17.69 6.31a.75.75 0 00-1.06-1.06l-1.59 1.59a.75.75 0 101.06 1.06l1.59-1.59zM5.23 16.63a.75.75 0 00-1.06-1.06l-1.59 1.59a.75.75 0 001.06 1.06l1.59-1.59z" />
  </svg>
);
...
export const PresentationChartBarIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.375 19.5h17.25m-17.25 0a1.125 1.125 0 01-1.125-1.125v-1.5c0-.621.504-1.125 1.125-1.125h17.25c.621 0 1.125.504 1.125 1.125v1.5c0 .621-.504 1.125-1.125 1.125m-17.25 0h17.25m-17.25 0H3.375m0 0v-6.375c0-.621.504-1.125 1.125-1.125h1.5c.621 0 1.125.504 1.125 1.125v6.375m0 0H6m0 0h1.5m0 0v-4.125c0-.621.504-1.125 1.125-1.125h1.5c.621 0 1.125.504 1.125 1.125V19.5m0 0h1.5m0 0h1.5m0 0v-7.5c0-.621.504-1.125 1.125-1.125h1.5c.621 0 1.125.504 1.125 1.125V19.5m0 0h1.5m0 0h1.5M12 4.5v.75m0 0l-3.75 3.75M12 5.25l3.75 3.75" />
  </svg>
);
...
export const MagicWandIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 00-5.78 1.128 2.25 2.25 0 01-2.4 2.245 4.5 4.5 0 008.4-2.245c0-.399-.078-.78-.22-1.128zm0 0a15.998 15.998 0 003.388-1.62m-5.043-.025a15.998 15.998 0 011.622-3.385m5.043.025a15.998 15.998 0 001.622-3.385m3.388 1.62a15.998 15.998 0 00-1.622-3.385m-5.043-.025a15.998 15.998 0 01-3.388-1.621m7.704 4.042a3 3 0 00-1.128-5.78 2.25 2.25 0 01-2.245-2.4 4.5 4.5 0 00-2.245 8.4c.399 0 .78-.078 1.128-.22z" />
  </svg>
);
...
export const SpinnerIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className={`${className} animate-spin`}>
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 3v3m0 12v3m9-9h-3m-12 0H3m16.636-7.364L18.364 7.636M7.636 18.364l-2.272-2.272m12.728 0l-2.272 2.272M7.636 5.636L5.364 7.636" />
  </svg>
);

export const ArrowPathIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0011.667 0l3.181-3.183m-4.991-2.693L19.015 7.74M2.985 19.644A8.25 8.25 0 0114.652 4.356L19.015 7.74m0 6.6l-3.181 3.183A8.25 8.25 0 012.985 4.356L7.348 7.74" />
  </svg>
);
...
export const PaintBrushIcon = MagicWandIcon;
...
export const ChatBubbleLeftEllipsisIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.625 12a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H8.25m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H12m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.764 9.764 0 01-2.555-.332A.75.75 0 018.38 19.562l-2.438-1.002c-.434-.178-.732-.57-.732-1.034v-2.625a8.25 8.25 0 00-3.25-6.967.75.75 0 01.293-1.332C3.513 7.043 4.49 6.25 5.625 5.51c1.346-.862 3.012-1.347 4.875-1.347 4.97 0 9 3.694 9 8.25z" />
    </svg>
);
...
export const BookOpenIcon = JournalIcon;
...
export const ArrowsPointingOutIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
