...
export const RetryPrompt: React.FC<RetryPromptProps> = ({ message, onRetry }) => {
    ...
    return (
        <div className="flex-grow flex flex-col justify-center items-center text-center text-gray-600 dark:text-gray-400 p-8 h-full">
            ...
            <h3 className="text-xl font-bold text-gray-800 dark:text-gray-200 mb-2">{t('error.api.title')}</h3>
