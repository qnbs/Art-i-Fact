...
const getEnhancementInstruction = (style: 'subtle' | 'descriptive' | 'artistic'): string => {
    switch (style) {
        case 'subtle':
            return 'Subtly refine this prompt for clarity and conciseness.';
        case 'artistic':
            return 'Make it more evocative by incorporating details about specific art history styles (e.g., Baroque, Cubism, Impressionism), famous artist techniques (e.g., chiaroscuro, impasto), and complex compositions.';
        case 'descriptive':
        default:
            return 'Make it more descriptive, visually rich, and evocative, incorporating details about art styles (e.g., oil painting, watercolor), lighting, and mood.';
    }
}
