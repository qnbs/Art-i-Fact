...
export const fetchWelcomeStatus = createAsyncThunk(
  "app/fetchWelcomeStatus",
  async () => {
...
const appSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(fetchWelcomeStatus.rejected, (state) => {
        state.status = "succeeded";
...
export const { setPreviewGallery, setShowWelcome, setInitialDiscoverSearch } =
  appSlice.actions;
